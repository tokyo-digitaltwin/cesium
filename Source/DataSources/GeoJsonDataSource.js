...
function createLineString(
  ...
  let material = options.polylineStrokeMaterialProperty;
...
function createPolygon(dataSource, geoJson, crsFunction, coordinates, options) {
  ...
  let outlineColorProperty = options.polygonStrokeColor;
...
GeoJsonDataSource.prototype.load = function (data, options) {
  ...
  options = {
    ...
    polylineStrokeMaterialProperty: new ColorMaterialProperty(
      defaultValue(
        getColor(options.polylineStroke),
        defaultValue(getColor(options.stroke), defaultStroke)
      )
    ),
    polygonStrokeColor: defaultValue(
      getColor(options.polygonStroke),
      defaultValue(getColor(options.stroke), defaultStroke)
    ),
